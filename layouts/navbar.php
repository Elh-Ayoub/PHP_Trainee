<nav class="main-header navbar navbar-expand-md navbar-light navbar-white" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px;">
    <div class="container">
        <a href="/" class="navbar-brand" id="sidebarToggle">
            <img src="<?php echo $configs['App_url'] . '/img/logo.png'?>" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8; width: 80px; ">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto d-flex align-items-center justify-content-center">
            <? if(isset($_SESSION['auth'])): ?>
                <li class="nav-item user-panel d-flex">
                    <div>
                        <a href="/profile" class="nav-link d-flex align-items-center justify-content-center">
                            <div class="image px-1">
                                <img src="<?php echo $_SESSION['auth']->profile_picture ?>" class="img-fluid img-circle" alt="User" width="30" height="30" style="border-radius: 50%; border: 1px solid grey;">
                            </div>
